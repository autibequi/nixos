...
2. Leia os arquivos de skills disponíveis para este repositório em `/workspace/stow/.claude/skills/monolito/*/SKILL.md`. Eles descrevem as skills que você pode invocar e como usá-las.

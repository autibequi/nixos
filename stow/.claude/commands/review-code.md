Faça um code review completo seguindo a skill `monolito/review-code`.

## Entrada
- `$ARGUMENTS`: número do PR, URL, nome de branch, ou "auto"
...
3. **IMPORTANTE:** Ao finalizar, verificar se aprendeu algo novo e atualizar `templates/knowledge.md`

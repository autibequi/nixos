...
local nixSearch    = L.build("google-chrome-stable --new-window https://search.nixos.org/", { gpu = "offload" })
local claude_app   = L.chrome("https://claude.ai/new")
local jira         = L.build("google-chrome-stable --new-window https://estrategia.atlassian.net/jira/software/c/projects/FUK2/boards/323?quickFilter=1182", { gpu = "offload" })

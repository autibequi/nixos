...
local menu         = L.build(HOME .. "/.config/hypr/scripts/walker-launch.sh", { raw = true })
...
-- Control panel: MOD3+SHIFT+p (SUPER+SHIFT+p é cycle profile em productivity/profiles.lua)

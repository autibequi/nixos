...
local clipboardWalker = L.build(HOME .. "/.config/hypr/scripts/walker-launch.sh --provider clipboard", { raw = true })
local powerWalker = L.build(HOME .. "/.config/hypr/scripts/walker-launch.sh --theme neon --provider menus:power", { raw = true })
local screenshotWalker = L.build(HOME .. "/.config/hypr/scripts/walker-screenshot.sh", { raw = true })
...
km.app("SUPER + SHIFT + Delete", HOME .. "/.config/hypr/scripts/shader-set.sh off",
    { desc = "Shader off", group = "System", icon = "🕶" })

-- NOTA: SUPER + Escape virou focus monitor +1 (em keybinds/workspace.lua).

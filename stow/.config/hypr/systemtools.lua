...
-- Window Management
hl.bind("SUPER + Tab",       hl.dsp.window.fullscreen(1))  -- maximize (não fullscreen real)
hl.bind("SUPER ALT + Tab",   hl.dsp.window.float())

-- Fullscreen
hl.bind("SUPER + F11",       hl.dsp.exec_cmd("hyprctl dispatch fullscreenstate 0 3"))  -- fullscreen externo
hl.bind("SUPER SHIFT + F11", hl.dsp.window.fullscreen(0))                               -- fullscreen real

...
**Why:** O flag `AUTOCOMMIT` em `~/.zion` controla isso. Se `AUTOCOMMIT=OFF` (default), commit requer autorização explícita do usuário. Commitar por conta própria quebra o contrato — o usuário perde controle do histórico git.

...
description: "Regras globais do sistema vennon — ativar sempre que tocar em: estrutura do vault, bedrooms, dashboard, cards, comunicacao entre agentes, scheduling, worktrees ou leis. Le e apresenta os arquivos de /workspace/self/superego/."
triggers:
  - "regras do sistema"
  - "leis dos agentes"
  - "estrutura do vault"

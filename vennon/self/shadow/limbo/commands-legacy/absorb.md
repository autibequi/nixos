...
Se `$ARGUMENTS` começar com `steal`: inspecionar a fonte, comparar com skills existentes do vennon e apresentar relatório de impacto.
...
### Fase 2 — Inventario do vennon (paralela com Fase 1)

```
Agent subagent_type=Explore prompt="
Mapeie as skills e capacidades atuais do vennon:
1. Todos os SKILL.md em /skills/ — nome e descricao
2. Commands em /vennon/commands/ — nome e proposito
3. /vennon/system/DIRETRIZES.md — regras cross-cutting
4. /vennon/ego/ — agentes disponiveis
"
```
...
|---------------|-------------|
| **ROUBAR** | Gap real, alto valor, sem conflito. Adaptar pro vennon. |
...
## ROUBAR (implementar no vennon)
| # | Funcionalidade | Impacto | Esforco |
Para cada item: o que roubar, prompt roubado, onde no vennon, risco

## MELHORAR (absorver tricks nos existentes)
| # | Skill vennon | O que melhorar | Trick da fonte |
...
- Adaptar prompts — nunca copiar 1:1, sempre adaptar pro formato vennon
...
**vennon atualizado:** skills/ego/commands modificados

...
## Estrutura de arquivos por serviço (/leech/containers/monolito/)
...
(host: `~/.local/share/leech/logs/<service>/`, mount: `~/.local/share/leech/logs` → `/workspace/logs/docker`)
...
- Sem --no-log-prefix, cada linha vinha prefixada com `leech-dk-monolito-app  | `

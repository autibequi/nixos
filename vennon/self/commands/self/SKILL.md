...
| Comando | O que faz |
|---------|-----------|
| `/self:ego` | Lista agentes ativos |
| `/self:ego:<nome>` | Detalhes de um agente |
| `/self:superego` | Regras globais ativas |
...
| `/self:context:contemplate` | Sintese estrategica |
| `/self:context:usage` | Uso e abuso do contexto |

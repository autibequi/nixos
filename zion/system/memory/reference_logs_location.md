...
Logs de monitoramento ficam em `/workspace/logs/` (disponível em todas as sessões, não só `zion host`).
...
- `/workspace/logs/host/journal/` — journal systemd do host NixOS (só em `zion host`)

...
- [reference_logs_location.md](reference_logs_location.md) — Logs em /workspace/logs/docker/<service>/ (service.log=runtime, test.log=testes); host: /tmp/zion-logs/dockerized/

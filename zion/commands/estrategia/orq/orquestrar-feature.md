...
Spawne o agente **Orquestrador** com o skill `orquestrar-feature`:

```
Agent subagent_type=Orquestrador prompt="Execute o skill orquestrar-feature para: $ARGUMENTS"
```
...
5. Delegar pra subagentes (Monolito, BoContainer, FrontStudent)

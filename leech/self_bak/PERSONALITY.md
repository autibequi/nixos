...
```bash
cp ~/.claude/projects/-workspace-mnt/memory/*.md /workspace/home/self/system/memory/ && git -C /workspace/home add leech/system/memory/ && git -C /workspace/home commit -m "chore(memory): sync"
```
